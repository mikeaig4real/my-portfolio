...
export interface IPortfolioDocument
  extends Omit<PortfolioData, "profile">, Document {
...
const BentoCustomizationConfigSchema = new Schema(
  {
    layoutMode: {
      type: String,
      enum: ["bento", "compact", "masonry"],
      default: "bento",
    },
    gridColumns: { type: Number, default: 4 },
    gridGap: { type: Number, default: 16 },
    shadowOffset: { type: Number, default: 4 },
    borderWidth: { type: Number, default: 2 },
    colorScheme: { type: String, default: "cyberpunk" },
...
const PortfolioSchema = new Schema<IPortfolioDocument>(
  {
    ...
    customization: BentoCustomizationConfigSchema
  },
  { timestamps: true },
);
